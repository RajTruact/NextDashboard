...
//             <button
//               onClick={() => handleSubmenuToggle(index, menuType)}
//               onMouseEnter={() => handleItemHover(`${menuType}-${index}`)}
...
//               </span>
//               {(isExpanded || isHovered || isMobileOpen) && (
//                 <span className="menu-item-text-container overflow-hidden">
//                   <span
//                     className={`menu-item-text ${
//                       hoveredItem === `${menuType}-${index}`
//                         ? "animate-marquee"
//                         : "truncate"
//                     }`}
//                   >
...
//                                 onMouseEnter={() =>
//                                   handleItemHover(
//                                     `${menuType}-${index}-sub-${subIndex}-child-${childIndex}`
//                                   )
//                                 }
//                                 onMouseLeave={handleItemLeave}
//                                 className={`menu-dropdown-item flex items-center gap-2 ${
...
//                                   </span>
//                                 )}
//                                 <span className="menu-dropdown-text-container overflow-hidden">
//                                   <span
...
//                         href={sub.path}
//                         onMouseEnter={() =>
//                           handleItemHover(`${menuType}-${index}-sub-${subIndex}`)
//                         }
//                         onMouseLeave={handleItemLeave}
//                         className={`menu-dropdown-item flex items-center gap-2 ${
//                           isActive(sub.path)
...
//         .menu-dropdown-text-container {
//           overflow: hidden;
//           white-space: nowrap;
//           flex: 1;
//         }

//         .menu-item:hover .animate-marquee {
//           animation-play-state: running;
//         }

//         .menu-item:not(:hover) .animate-marquee {
//           animation: none;
//         }
//       `}</style>
//     </aside>
...
// we have the master report, inside that report we have more than 1000 plus records inside that record we have the sourcedate time field and pending
